...
fetch('http://localhost:3000/categories')
   ...
   const fetchProducts = () => {
    ...
    sortSelect.addEventListener('change', () => {
        ...
        }else if (sortingOption === 'forMen') {
            sortedProducts = productsData.filter(product => product.gender === 'Men');
        } else if (sortingOption === 'forWomen') {
            sortedProducts = productsData.filter(product => product.gender === 'Women');
        }
